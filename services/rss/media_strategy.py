...
class MediaSendStrategyManager:
    ...
    def __init__(self, use_local_api: bool = False):
        ...
        self.large_file_threshold_mb = (
            self.config.large_file_threshold_local if use_local_api
            else self.config.large_file_threshold_official
        )
    ...
    def _check_media_accessibility(self, media_url: str) -> Tuple[bool, str, float]:
        ...
        return network_manager.check_url_accessibility(media_url, use_cache=True)
