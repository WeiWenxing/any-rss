...
class SampleHelpProvider(ModuleHelpProvider):
    ...
    def get_basic_commands(self) -> str:
        """获取基础命令帮助信息"""
        return (
            "• /sample_add <样本链接> <频道ID> - 添加样本账号订阅\n"
            "• /sample_del <样本链接> <频道ID> - 删除样本账号订阅\n"
            "• /sample_list [频道ID] - 查看订阅列表"
        )

    def get_debug_commands(self) -> str:
        """获取调试命令帮助信息"""
        return (
            "• /sample_debug_show <样本链接> - 显示单个样本内容项"
        )

    def get_examples(self) -> str:
        """获取使用示例"""
        return (
            "• /sample_add https://www.sample.com/user/MS4wLjABAAAA... @mychannel\n"
            "• /sample_add https://v.sample.com/iM5g7LsM/ -1001234567890\n"
            "• /sample_list @mychannel\n"
            "• /sample_del https://www.sample.com/user/MS4wLjABAAAA... @mychannel"
        )
...
def register_help_provider():
    ...
    get_help_manager().register_provider("sample", provider) 